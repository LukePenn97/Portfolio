...
var twoSum = function(nums, target) {
    ...
    <div>The best hash function depends on the data you're trying to hash. For example, a simple hash function would be tyo just take the first character of a string and multiply it by the last character's value</div>
    ...
    <div>The code above uses javascript's default hashmap. First we generate a new empty map, then we initiate a loop and set the complement to the target - the current numer in the array</div>
    ...
    <div>We now insert the first number in the array into the hashmap withh it's index. Then we repeat this process.</div>
